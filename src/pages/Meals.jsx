...
const Meals = () => {
    ...
    return (
        <div className="mt-32 max-w-7xl mx-auto p-4">
            ...
            <h1 className="text-center text-2xl font-semibold text-gray-500 ">---Ready for your meals <span className="text-orange-600">({data.length})</span> please view meal and send request Meal---</h1>
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <select
                        ...
                        value={priceRange || ''}
                        className="block w-96 mt-1 border px-8 py-1 border-gray-300 rounded-md focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                    >
